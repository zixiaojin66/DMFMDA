...
parser.add_argument('--wd', type=float, default=1e-1, help='weight_decay')
...
parser.add_argument("--gat_activation", default='relu', help='gat activation')
...
parser.add_argument('--neighbor', type=int, default=10, help='neighbor')
